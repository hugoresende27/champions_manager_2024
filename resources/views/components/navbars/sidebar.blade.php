...
<aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'team-profile' ? 'active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'team-management' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'squad' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('squad') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
